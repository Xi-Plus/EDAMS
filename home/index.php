...
<table border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<strong>簡介</strong>
		<hr>
		<p><strong>EDAMS (Experimental Data Analysis and Management System)</strong>是一個開放原始碼專案，原始碼皆可在<a href = "https://github.com/Xi-Plus/EDAMS" target="_blank">GitHub</a>上找到。</p>
		<p>此系統用來作為實驗數據的分析與管理。</p>
		...
		<table border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="100" valign="top">2015.02.14</td>
			<td>開始開發</td>
		</tr>
		</table>
	</td>
